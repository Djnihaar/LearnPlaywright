...
test.describe('Automation - Working With Elements', () => {
  ...
  test("browse context test", async ({browser}) => {
    ...
    await page1.getByPlaceholder('First Name').fill(`Kunal`);
    await page1.getByPlaceholder('Last Name').fill(`M`);
      await page1.locator('//input[@class="oxd-input oxd-input--active"]').last().fill(`13234582`);
    await page1.locator('//input[@type="checkbox"]').dispatchEvent('click');
    await page1.locator("//label[text()='Username']/../following-sibling::div/input").fill("Kunal")
    await page1.locator("//label[text()='Password']/../following-sibling::div/input").fill("Pass@12345")
    await page1.locator("//label[text()='Confirm Password']/../following-sibling::div/input").fill("Pass@12345")

    await page1.locator('button[type="submit"]').click();


    await page2.goto('https://opensource-demo.orangehrmlive.com/');
    await page2.locator('input[name="username"]').fill("Kunal")
    await page2.locator("input[type='password']").fill("Pass@12345")
    ...
    await expect(page2).toHaveURL('https://opensource-demo.orangehrmlive.com/web/index.php/dashboard/index')
     ...
     //await page1.locator('//button[@type="submit"]').click()
     await page1.locator("(//button[@type='submit'])[1]").click();
