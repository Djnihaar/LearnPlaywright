...
// test('Should  add Brocoli and Cauliflower to cart and varify total price', async ({ page }) => {
...
test('Should add Broccoli and Cauliflower to cart and verify total price', async ({ page }) => {
